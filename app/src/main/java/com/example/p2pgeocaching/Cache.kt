...
import com.example.p2pgeocaching.p2pexceptions.StringContainsSemicolonException
 ...
 * [creator] contains the name of the cache's creator, also no ';' allowed.
...
class Cache(
    ...
    constructor(title: String, desc: String, creator: String) : this(
        ...
        // This checks if the arguments contain a semicolon, which it should not
        val argList: ArrayList<String> = arrayListOf(title, desc, creator)
        checkForSemicolons(argList)
     ...
     * Throws keysDoNotMatchException and stringContainsSemicolonException
     */
    fun foundCache(finder: String, newPrvKey: PrivateKey) {
        ...
        // no string may contain a semicolon
        if (finder.contains(';')) {
            throw StringContainsSemicolonException()
        }
    ...
    /**
     * Simple function that checks if any of the Strings provided in [arguments] contains a ';'
     * If it does, throws a StringContainsSemicolonException
     */
    private fun checkForSemicolons(arguments: List<String>) {
